...
<div class="space-y-6">
    ...
    <div class="mb-6 flex justify-between items-end">
        <div>
            <h1 class="text-2xl font-bold text-[#1C2C4E]">Tambah Indikator Penilaian</h1>
            <p class="text-sm text-slate-500 mt-1">Definisikan aspek pengajuan bantuan dan aturan skor kelayakannya.</p>
        </div>
    ...
    <form action="{{ route('admin.scoring_indicators.store') }}" method="POST">
        @csrf
