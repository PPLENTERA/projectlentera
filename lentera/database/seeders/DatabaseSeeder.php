...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\ScoringIndicator::truncate();
        \App\Models\ScoringRule::truncate();
        ...
        $statusRumahInd = \App\Models\ScoringIndicator::create([
            'name' => 'Status Rumah',
            'column_name' => 'status_rumah',
        ]);
        $statusRumahInd->rules()->createMany([
            [
                'operator' => '=',
                'value' => 'Sewa/Kontrak',
                'score' => 30,
        ...
        $buktiPendukungInd = \App\Models\ScoringIndicator::create([
            'name' => 'Bukti Pendukung',
            'column_name' => 'bukti_pendukung',
        ]);
        $buktiPendukungInd->rules()->createMany([
            [
                'operator' => '=',
                'value' => 'Ada',
                'score' => 15,
        ...
        $sktmInd = \App\Models\ScoringIndicator::create([
            'name' => 'Surat Keterangan Tidak Mampu (SKTM)',
            'column_name' => 'sktm',
        ]);
        $sktmInd->rules()->createMany([
            [
                'operator' => '=',
                'value' => 'Ada',
                'score' => 25,
